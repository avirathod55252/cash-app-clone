...
const CashApp: FunctionComponent = () => {
  ...
  return (
    <div className="relative bg-light-white w-full h-[694px] overflow-hidden text-center text-174xl text-light-white "style={containerStyle}>
      <div className="absolute w-full top-[-27px] right-[0px] left-[0px] bg-black h-[721px]">
        ...
        />
        <div className="absolute top-[-248px] left-[0px] w-[1360px] h-[1360px] overflow-hidden">
          <div className="absolute top-[289px] left-[-56px] w-[1366px] h-[692px] overflow-hidden">
            ...
            {/* <div className="absolute h-[43.77%] w-[49.50%] top-[20.87%] left-[23.72%] tracking-[0.5px] leading-[166px] uppercase flex items-center justify-center">
              CASh
            </div> */}
            <div
              className="absolute h-[43.77%] w-[49.50%] top-[20.87%] left-[23.72%] tracking-[0.5px] leading-[166px] uppercase flex items-center justify-center"
              style={{ fontFamily: "Arial, Helvetica, sans-serif" }}
            >
              <span className="font-bold text-white">CA Sh</span>
            </div>

            <img
              className="absolute h-[65.47%] w-[27.09%] top-[20.81%] right-[36.46%] bottom-[13.72%] left-[36.46%] max-w-full overflow-hidden max-h-full object-cover"
              alt=""
            ...
            />
            <img
              className="absolute h-[37.7%] w-[14.64%] top-[6.94%] right-[9.59%] bottom-[55.36%] left-[75.77%] max-w-full overflow-hidden max-h-full object-cover"
              alt=""
              src="/introstairs-1@2x.png"
            />
          </div>
        </div>
        <div className="absolute w-[calc(100%_-_123px)] top-[637px] right-[63px] left-[60px] h-[65px] overflow-hidden text-left text-[10px] text-silver font-mulish">
          <div className="absolute top-[calc(50%_-_24.5px)] left-[calc(50%_-_621.5px)] flex flex-col items-center justify-start">
            <div className="flex flex-row items-center justify-start gap-[20px]">
              <button className="cursor-pointer p-[25px] bg-black rounded-6xs box-border w-[170px] h-[50px] flex flex-row items-center justify-between border-[1px] border-solid border-light-white">
                <img
                  className="relative w-[19.22px] h-[22.82px]"
                  alt=""
                  src="/vector1.svg"
                />
                <div className="relative text-xs tracking-[0.5px] leading-[18px] uppercase font-hero-text text-light-white text-center">
                  APP STORE
                </div>
              </button>
              <button className="cursor-pointer p-3 bg-black rounded-6xs box-border w-[170px] h-[50px] flex flex-row items-center justify-between border-[1px] border-solid border-light-white">
                <img
